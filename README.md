...
The functionality of the precompiled files can be tested with the Digital Micrograp script [getBeamTilt.s](src/data_collection/BeamTilt_API/getBeamTilt.s).
